...
| Designation | Description |
| -- | -- |
| Linked pages | Lists all pages which are linked to the navigation point. As mentioned above links from several pages work time-dependent to one navigation point. |
