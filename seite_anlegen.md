...
| Designation | Description |
| -- | -- |
| Linked pages | Lists all pages who are linked to the navigation point. As mentioned above links from several pages work time-dependent to one navigation point. |
